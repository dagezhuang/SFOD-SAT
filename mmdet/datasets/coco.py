...
class CocoDataset(CustomDataset):
    ...
    CLASSES = ('fish',)
    # CLASSES = ('nematode',)
    # CLASSES = ('freighter', 'rear_engine_aircraft', 'train', 'naval_vessels',
    #             'yacht', 'narrow_bodied_aircraft', 'cruise', 'four_engine_aircraft',
    #             'wide_bodied_aircraft', 'speed_boat', 'corporate_aircraft','other_ship')

...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        if self.data_root is not None:
            ...
            if not (self.jet_prefix is None or osp.isabs(self.jet_prefix)):
                self.jet_prefix = osp.join(self.data_root, self.jet_prefix)
    ...
    def pre_pipeline(self, results):
        ...
        results['jet_prefix'] = self.jet_prefix
